  ...
  head: () => ({
    meta: [
      { title: "Lokality AI — Enterprise AI Recruitment Intelligence Platform" },
      {
        name: "description",
        content:
          "Automate the complete hiring lifecycle—from resume ingestion and matching to adaptive interviews, proctoring, explainable evaluations, and hiring decisions.",
      },
    ],
  }),
  component: Landing,
  ...
  Platform: [
    {
      ...
      desc: "Your command center for active campaigns and applicant pipelines.",
      icon: "dashboard",
    },
    {
      label: "Candidate Intelligence",
      desc: "Deep profiles combining resumes, skills, and assessment histories.",
      icon: "person_search",
    },
    {
      label: "Interview Management",
      desc: "Configure interview parameters, duration, rubrics, and schedules.",
      icon: "video_chat",
    },
    {
      label: "Hiring Analytics",
      desc: "Track conversions, screening speed, consistency index, and time-to-hire.",
      icon: "analytics",
    },
  ],
  Products: [
    {
      ...
      desc: "Ingest, parse, and structure qualifications automatically.",
      icon: "description",
    },
    {
      label: "JD Matcher",
      desc: "Compare candidate skills against job descriptions semantically.",
      icon: "compare_arrows",
    },
    {
      label: "Adaptive Interview Engine",
      desc: "AI personas that conduct conversational, adaptive screening screens.",
      icon: "psychology",
    },
    {
      label: "Enterprise Proctoring",
      desc: "Integrity checks featuring facial monitoring, browser tab logs, and alerts.",
      icon: "security",
    },
    {
      label: "Explainable AI Reports",
      desc: "Scorecards with transcript-backed verbatim citations and weighting details.",
      icon: "summarize",
    },
  ],
  Workflows: [
    {
      ...
      desc: "Filter thousands of incoming resumes instantly with zero bias.",
      icon: "bolt",
    },
    {
      label: "Technical Assessments",
      desc: "Evaluate complex system design, coding, or compliance with specialized personas.",
      icon: "code",
    },
    {
      label: "Behavioral STAR Screens",
      desc: "Structured situational questions probing soft skills and leadership values.",
      icon: "stars",
    },
    {
      label: "Campus & Graduate Hiring",
      desc: "Manage bulk assessment batches with live proctoring logs.",
      icon: "school",
    },
  ],
  "AI Intelligence": [
    {
      ...
      desc: "Clear rating cards detailing how factors weight into the hiring recommendation.",
      icon: "account_tree",
    },
    {
      label: "Adaptive Persona Engine",
      desc: "Deploy domain-specific agents that probe details of candidate claims.",
      icon: "smart_toy",
    },
    {
      label: "Semantic JD Alignment",
      desc: "Beyond keywords—comprehend experience, seniority context, and fit.",
      icon: "hub",
    },
    {
      label: "Competency Mapping",
      desc: "Instantly translate resumes and profiles into standardized competency trees.",
      icon: "insights",
    },
  ],
  Enterprise: [
    {
      label: "Security & SOC 2 Compliance",
      desc: "Isolated multi-tenant architecture, data encryption, and compliance controls.",
      icon: "shield",
    },
    {
      label: "SSO & SAML",
      desc: "Integrate Okta, Azure AD, and custom single sign-on providers.",
      icon: "key",
    },
    {
      label: "Role-Based Access (RBAC)",
      desc: "Configure permissions for admins, recruiters, and hiring managers.",
      icon: "admin_panel_settings",
    },
    {
      label: "Audit Logs",
      desc: "Immutable trail of every evaluation access, parameter modification, and login.",
      icon: "receipt_long",
    },
  ],
  Resources: [
    {
      label: "Documentation",
      desc: "Developer API endpoints, configuration schemas, and quickstart guides.",
      icon: "menu_book",
    },
    {
      label: "Hiring Playbooks",
      desc: "Standard frameworks for building fair, persona-driven interview schedules.",
      icon: "library_books",
    },
    {
      label: "API Reference",
      desc: "Integrate Lokality AI directly into Greenhouse, Workday, Lever, or Ashby.",
      icon: "terminal",
    },
    {
      label: "Support Center",
      desc: "Access 24/7 dedicated support and customer success channels.",
...
const PIPELINE_STAGES = [
  {
    ...
    desc: "Candidates submit applications through branded portals, job boards, or direct scheduling links.",
  },
  {
    id: "s2",
    label: "Resume Upload",
    desc: "Resumes are ingested, parsed, and converted to structured records immediately.",
  },
  {
    id: "s3",
    label: "AI Resume Intelligence",
    desc: "AI extracts skills, experience years, key achievements, and certifications.",
  },
  {
    id: "s4",
    label: "JD Match Score",
    desc: "Semantic analysis matches the candidate profile against job descriptions to compute alignment.",
  },
  {
    id: "s5",
    label: "Candidate Ranking",
    desc: "Applicants are ranked by job fit, highlighting top talent instantly to recruiters.",
  },
  {
    id: "s6",
    label: "Interview Assignment",
    desc: "Hiring workflows assign domain-specific AI interview personas and standard scoring rubrics.",
  },
  {
    id: "s7",
    label: "AI Adaptive Interview",
    desc: "The assigned AI persona hosts a conversational screen, dynamically probing candidate answers.",
  },
  {
    id: "s8",
    label: "Enterprise Proctoring",
    desc: "Webcam detection, audio alerts, and tab lock tracking maintain interview integrity.",
  },
  {
    id: "s9",
    label: "Explainable AI Evaluation",
    desc: "AI generates a factor-weighted scorecard with candidate quotes citing verbatim transcript evidence.",
  },
  {
    id: "s10",
    label: "Recruiter Review",
    desc: "Hiring managers review transcripts, recordings, and explainable recommendations in a structured dashboard.",
  },
  {
    id: "s11",
    label: "Hiring Decision",
    desc: "Recruitment intelligence drives offer consensus, accelerating approval workflows.",
  },
];
...
const WORKFLOW_STEPS = [
  {
    ...
    desc: "Ingest candidates automatically via ATS sync, job board integrations, or custom landing pages.",
  },
  {
    step: "Step 2",
    title: "AI Resume Parsing",
    desc: "AI extracts skills, past job milestones, and qualifications into clean, searchable profiles.",
  },
  {
    step: "Step 3",
    title: "JD Matching",
    desc: "Semantic intelligence processes job specifications to compare applicant backgrounds contextually.",
  },
  {
    step: "Step 4",
    title: "Candidate Ranking",
    desc: "Applicants are stacked by suitability score, instantly revealing the top matches.",
  },
  {
    step: "Step 5",
    title: "Interview Assignment",
    desc: "Workflows select the ideal AI persona, difficulty parameters, and duration metrics.",
  },
  {
    step: "Step 6",
    title: "AI Interview",
    desc: "The candidate enters the interview room where a conversational persona conducts a natural, adaptive session.",
  },
  {
    step: "Step 7",
    title: "Enterprise Proctoring",
    desc: "Integrity monitors run browser audits, webcam presence validation, and audio analysis.",
  },
  {
    step: "Step 8",
    title: "AI Evaluation",
    desc: "XAI scores candidate competencies, generating explainable recommendations with cited proof.",
  },
  {
    step: "Step 9",
    title: "Recruiter Decision",
    desc: "Hiring managers compare scorecards, view transcripts, and align feedback on one central board.",
  },
  {
    step: "Step 10",
    title: "Hiring",
    desc: "Confirm the best-fit talent, trigger onboarding, and push status updates to your ATS database.",
  },
];
...
const COMPARISON_ROWS = [
  {
    ...
    traditional: "Manual Resume Screening (hours or days per role)",
    lokality: "AI Resume Intelligence — scored and parsed in seconds",
  },
  {
    stage: "Interview Scheduling",
    traditional: "Back-and-forth emails, coordination delays",
    lokality: "Automated Scheduling — instant invites upon candidate match",
  },
  {
    stage: "Interviews",
    traditional: "Subjective initial screens, varying standards, bias",
    lokality: "Standardized Adaptive AI Interviews — uniform questions tailored to JD",
  },
  {
    stage: "Evaluation & Grading",
    traditional: "Gut decisions, scribble notes, slow feedback loop",
    lokality: "Explainable AI Reports — transcript-cited competency cardboards",
  },
  {
    stage: "Integrity Tracking",
    traditional: "No proctoring or validation on remote calls",
    lokality: "Live Proctoring — facial logs, audio monitoring, tab locks",
  },
  {
    stage: "Hiring Decisions",
    traditional: "Disjointed team syncs, hiring delays",
    lokality: "Hiring Recommendations — recruiter decision-support dashboard",
  },
];
...
const BUSINESS_OUTCOMES = [
  {
    ...
    val: "85%",
    desc: "Shorten your recruitment lifecycle from 42 days to under a week using fully automated screening pipelines.",
  },
  {
    title: "Improve recruiter productivity",
    val: "10×",
    desc: "Enable talent acquisition teams to manage 10x more candidate flows without compromising vetting quality.",
  },
  {
    title: "Increase interview consistency",
    val: "100%",
    desc: "Guarantee every candidate is evaluated against uniform rubrics and role competencies.",
  },
  {
    title: "Reduce manual screening effort",
    val: "90%",
    desc: "Let AI handle resume parsing, parsing validation, alignment grading, and initial phone screens.",
  },
  {
    title: "Improve hiring quality",
    val: "95%",
    desc: "Make decisions backed by explainable AI scoring, transcripts, and proctored records.",
  },
  {
    title: "Enterprise-grade compliance",
    val: "SOC2",
    desc: "Data isolation, SAML SSO, and complete audit tracking aligning with corporate security policies.",
  },
];
    ...
    >
      <div className="max-w-[1440px] mx-auto px-6 h-16 flex items-center justify-between">
        ...
        <div className="flex items-center gap-2">
          ...
          <span className="text-[10px] tracking-widest font-semibold px-2 py-0.5 rounded bg-slate-100 text-slate-500 border border-slate-200/50 uppercase">
            RECRUITMENT
          </span>
        </div>
        ...
        <div className="hidden lg:flex items-center gap-1">
          {Object.keys(NAV_MENU_DETAILS).map((key) => (
            <div key={key} className="relative">
              ...
              >
                {key}
                <span
                  className={`material-symbols-outlined text-[16px] transition-transform duration-200 ${activeMenu === key ? "rotate-180" : ""}`}
                >
                  expand_more
                </span>
              </button>
          ...
          <a
            href="#pricing"
            className="px-3.5 py-1.5 rounded-lg text-sm font-medium text-slate-600 hover:text-slate-900 hover:bg-slate-50"
          >
            Pricing
          </a>
        </div>
            ...
            <div key={key} className="space-y-1">
              ...
              <div className="grid grid-cols-2 gap-2 pl-2">
                {NAV_MENU_DETAILS[key].map((item) => (
                  <div
                    key={item.label}
                    className="py-1 text-sm font-medium text-slate-700 hover:text-indigo-600"
                  >
                    {item.label}
                  </div>
                ))}
      ...
      <div className="max-w-[1280px] mx-auto relative z-10">
        <div className="text-center max-w-4xl mx-auto mb-16 animate-fade-in-up flex flex-col items-center">
          ...
          <p className="text-base sm:text-lg text-slate-600 leading-relaxed max-w-2xl mx-auto mb-8 px-4 sm:px-0">
            From resume collection to hiring decisions, automate the entire recruitment lifecycle
            using AI-powered screening, adaptive interviews, explainable evaluations, and
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-3.5 mb-10 w-full sm:w-auto">
            ...
            >
              <span className="material-symbols-outlined text-indigo-600 text-[20px] icon-fill">
                play_circle
              </span>
              Watch Platform Tour
            </button>
          ...
          <div className="flex flex-wrap items-center justify-center gap-x-8 gap-y-3 pt-5 border-t border-slate-200/60 w-full max-w-xl text-slate-500 font-medium text-xs sm:text-sm">
            <div className="flex items-center gap-1.5">
              <span className="material-symbols-outlined text-emerald-500 text-[18px] icon-fill">
                verified
              </span>
            ...
            {PIPELINE_STAGES.map((stage, idx) => {
              ...
              return (
                ...
                >
                  ...
                  <p
                    className={`text-xs font-bold ${active ? "text-indigo-900" : "text-slate-800"} line-clamp-1`}
                  >
                    {stage.label}
                  </p>
      ...
      <div className="max-w-[1280px] mx-auto px-6">
        <div className="max-w-2xl mb-16">
          ...
          <p className="text-base text-slate-500 mt-3">
            Every feature is production-ready, security-first, and designed to streamline complex
            enterprise talent screening.
          </p>
        </div>
    ...
    <section className="py-24 bg-slate-50/50 border-b border-slate-200/50">
      <div className="max-w-[1280px] mx-auto px-6">
        <div className="text-center max-w-2xl mx-auto mb-16">
          ...
          <p className="text-base text-slate-500 mt-3">
            Go from candidate ingestion to final hiring decision in a ten-step structured
            intelligence flow.
          </p>
        </div>
        ...
        <div className="p-6 bg-white border border-slate-200 rounded-xl space-y-4 text-slate-700 text-xs">
          <div className="flex justify-between items-center border-b border-slate-100 pb-3">
            ...
            <input
              ...
              className="px-3 py-1 border border-slate-200 rounded bg-slate-50 text-[10px] outline-none"
              disabled
            />
          </div>
      ...
      layout: () => (
        <div className="p-6 bg-white border border-slate-200 rounded-xl space-y-4 text-slate-700 text-xs">
          <div>
            ...
            <input
              type="text"
              value="Senior Backend Engineer - Distributed Systems"
              className="w-full px-3 py-2 border border-slate-200 rounded bg-slate-50 font-medium"
              disabled
            />
          </div>
          <div>
            ...
            <div className="flex flex-wrap gap-1.5 mt-1">
              {["Golang", "PostgreSQL", "Kafka", "System Design", "Kubernetes"].map((skill) => (
                <span
                  key={skill}
                  className="px-2.5 py-1 rounded bg-indigo-50 text-indigo-700 border border-indigo-100 font-semibold text-[10px]"
                >
                  {skill}
                </span>
              ))}
          ...
          <div className="space-y-3">
            ...
            <div>
              <span className="text-[10px] font-bold text-slate-400 uppercase block mb-1">
                Interviewer Prompt Parameters
              </span>
              <div className="bg-slate-50 p-2.5 rounded border border-slate-200 text-[10px] font-mono text-slate-500 italic">
                \"Probe system tradeoffs. Do not accept high-level claims. Ask candidate to detail
                database lock handling in distributed systems...\"
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="p-6 bg-white border border-slate-200 rounded-xl space-y-3 text-slate-700 text-xs">
          ...
          <div className="space-y-2">
            <div className="p-2 border border-slate-100 rounded bg-slate-50/50">
              <span className="text-[9px] bg-indigo-50 border border-indigo-100 text-indigo-700 px-1.5 py-0.5 rounded font-bold uppercase">
                System Design
              </span>
              <p className="font-bold text-slate-800 mt-1">
                Describe exactly-once consumption logic across distributed Kafka partitions.
              </p>
            </div>
            <div className="p-2 border border-slate-100 rounded bg-slate-50/50">
              <span className="text-[9px] bg-purple-50 border border-purple-100 text-purple-700 px-1.5 py-0.5 rounded font-bold uppercase">
                STAR Behavioral
              </span>
              <p className="font-bold text-slate-800 mt-1">
                Tell me about a time you had a deadlock in production and how you handled team
                consensus.
              </p>
            </div>
          </div>
      ...
      layout: () => (
        <div className="p-6 bg-slate-950 text-slate-100 rounded-xl space-y-4 text-xs relative overflow-hidden">
          ...
          <div className="grid grid-cols-2 gap-3">
            <div className="aspect-video bg-slate-900 border border-slate-800 rounded-lg flex flex-col items-center justify-center text-center p-3 relative">
              ...
              <p className="text-[8px] text-slate-400">
                \"How do you ensure consistency on database write partitions?\"
              </p>
            </div>
            <div className="aspect-video bg-slate-900 border border-slate-800 rounded-lg flex flex-col items-center justify-center text-center p-3 relative">
              ...
              <span className="absolute bottom-1 right-1 text-[8px] bg-emerald-500/20 text-emerald-400 px-1 rounded uppercase">
                Webcam OK
              </span>
            </div>
          </div>
          ...
          <div className="bg-slate-900 border border-slate-800 p-2.5 rounded font-mono text-[9px] text-slate-400">
            <span className="text-indigo-400">Transcript Stream:</span> \"We implement transactional
            outboxes combined with transactional consumer polling to prevent write desync...\"
          </div>
        </div>
      ),
    },
      ...
      layout: () => (
        <div className="p-6 bg-white border border-slate-200 rounded-xl space-y-4 text-slate-700 text-xs">
          <div className="flex justify-between items-center border-b border-slate-100 pb-2">
            ...
            <span className="text-xl font-extrabold text-indigo-600 bg-indigo-50 border border-indigo-100 px-3 py-1 rounded-lg">
              95/100
            </span>
          </div>
          <div className="space-y-2">
            ...
            <div className="bg-indigo-50/50 p-2.5 rounded border border-indigo-100/50 text-[10px] text-indigo-900 leading-normal">
              <span className="font-bold text-indigo-800">Explainable AI Insight:</span> \"Candidate
              demonstrated thorough comprehension of partition semantics and cited practical edge
              case logs from previous deployments.\"
            </div>
          </div>
        </div>
      ),
    ...
    <section id="platform-preview" className="py-24 bg-white border-b border-slate-200/50">
      <div className="max-w-[1280px] mx-auto px-6">
        <div className="text-center max-w-2xl mx-auto mb-16">
          ...
          <p className="text-base text-slate-500 mt-3">
            Explore the different workspace environments inside Lokality AI without leaving the
            page.
          </p>
        </div>
          ...
          <div className="lg:col-span-1 space-y-2">
            {Object.keys(tabContent).map((tabKey) => {
              ...
              return (
                ...
                >
                  <span
                    className={`material-symbols-outlined text-[20px] ${active ? "text-indigo-600" : "text-slate-400"}`}
                  >
                    {tabKey === "dashboard"
                      ? "dashboard"
                      : tabKey === "candidates"
    ...
    <section className="py-24 bg-slate-50/50 border-b border-slate-200/50">
      <div className="max-w-[1280px] mx-auto px-6">
        <div className="max-w-2xl mb-16">
          ...
          <p className="text-base text-slate-500 mt-3">
            Secure integrations and compliance options to meet rigorous IT and security
            requirements.
          </p>
        </div>
      ...
      <div className="max-w-[1280px] mx-auto px-6">
        ...
        <div className="max-w-4xl mx-auto border border-slate-200 rounded-2xl overflow-hidden shadow-sm">
          ...
          {COMPARISON_ROWS.map((row) => (
            <div
              key={row.stage}
              className="grid grid-cols-3 border-b border-slate-100 last:border-0 p-4 text-xs text-slate-700 items-center"
            >
              ...
              <div className="pr-4 leading-normal flex items-start gap-1 text-slate-500">
                <span className="material-symbols-outlined text-red-500 text-[16px] shrink-0 mt-0.5">
                  cancel
                </span>
                {row.traditional}
              </div>
      ...
      <div className="max-w-[1280px] mx-auto px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {BUSINESS_OUTCOMES.map((item) => (
            <div
              key={item.title}
              className="p-6 bg-white border border-slate-200 rounded-2xl shadow-sm text-left"
            >
              <span className="text-4xl font-extrabold text-indigo-600 tracking-tight block">
                {item.val}
              </span>
    ...
    <section className="py-24 bg-indigo-600 text-white relative overflow-hidden text-center">
      ...
      <div className="max-w-[1280px] mx-auto px-6 relative z-10">
        ...
        <p className="text-base sm:text-lg text-indigo-100 max-w-2xl mx-auto mb-8 leading-relaxed">
          Join modern HR and talent teams who use Lokality AI to eliminate bias, enforce compliance,
          and reduce time-to-hire by 85%.
        </p>
        ...
        <div className="grid grid-cols-2 md:grid-cols-6 gap-8 mb-12">
          ...
          <div className="col-span-2">
            ...
            <p className="text-xs text-slate-500 leading-relaxed max-w-xs">
              Automating hiring pipelines with explainable assessments, domain personas, and secure
              proctoring logs.
            </p>
