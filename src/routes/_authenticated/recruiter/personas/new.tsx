      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-lg">
        <CardShadow className="lg:col-span-2 p-lg space-y-md">
          ...
          <Field label="System Prompt">
            <textarea
              ...
              className="ip font-data-mono"
              placeholder="You are a principal engineer at a top-tier tech company…"
            />
          </Field>
          <div className="flex gap-sm pt-md">
            ...
            <button
              ...
              disabled={saving}
              onClick={save}
              className="px-4 py-2 bg-primary text-on-primary rounded-lg hover:brightness-110"
            >
              Create persona
            </button>
          </div>
        ...
        <CardShadow className="p-lg ai-insight h-fit">
          ...
          <p className="text-body-md text-on-surface-variant">
            "Hi, I'm {form.name || "your interviewer"}. Today we'll spend ~45 minutes on{" "}
            {form.persona_type} questions at a {form.difficulty.toLowerCase()} difficulty level. My
            style is {form.tone.toLowerCase()}."
          </p>
        </CardShadow>
      </div>
