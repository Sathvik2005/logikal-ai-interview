...
import { listPersonas, getPersona, upsertPersona, deletePersona, type PersonaDTO } from "@/lib/personas.functions";
...
export function usePersonasQuery() { return useQuery(personasListOptions()); }
...
export function useUpsertPersona() {
  ...
  return useMutation({
    mutationFn: (input: { id?: string; name: string; personaType?: string | null; tone?: string | null; difficulty?: string | null; prompt?: string | null }) => fn({ data: input }),
