...
>(({ side = "right", className, children, ...props }, ref) => {
  ...
  const baseClass = sheetVariants({ side });
  const resolvedClass = hasMaxWidth ? baseClass.replace(/\bsm:max-w-sm\b/g, "") : baseClass;
  return (
    <SheetPortal>
      <SheetOverlay />
      <SheetPrimitive.Content ref={ref} className={cn(resolvedClass, className)} {...props}>
